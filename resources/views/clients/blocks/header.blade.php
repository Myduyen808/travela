...
<!-- Mirrored from webtendtheme.net/html/2024/Travela/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 09:28:37 GMT -->
                            ...
                            <div class="menu-sidebar">
                                <li class="drop-down">
                                    <button class="dropdown-toggle bg-transparent" id="userDropdown">
                                        <i
                                            class='bx bxs-user bx-tada'style="font-size: 36px; color:rgba(0, 0, 0, 0.3);"></i>
                                    </button>
